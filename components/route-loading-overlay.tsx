...
export function RouteLoadingOverlay() {
  ...
  return (
    <div className="fixed inset-0 z-[10000] flex items-center justify-center overflow-hidden" role="status" aria-live="polite" aria-label="Loading Rennovex Technology">
      ...
      <div className="relative flex flex-col items-center px-6 text-center">
        <div className="relative grid h-28 w-28 place-items-center sm:h-32 sm:w-32">
          ...
          <div className="relative grid h-[88px] w-[88px] place-items-center overflow-hidden rounded-full bg-white shadow-inner sm:h-[102px] sm:w-[102px]">
            <div className="scale-[1.65]"><SiteLogo compact /></div>
          </div>
        </div>
