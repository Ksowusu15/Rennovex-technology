    ...
    <>
      <section className="border-b border-slate-100 bg-gradient-to-b from-blue-50/70 to-white">
        <div className="container-shell py-12 sm:py-16 lg:py-20">
          <MotionReveal className="grid gap-8 lg:grid-cols-[1fr_.65fr] lg:items-end]">
      ...
      <section className="bg-white py-10 sm:py-14 lg:py-16">
        <div className="container-shell">
          {projects.length > 0 ? (
            <MotionStagger className="grid gap-6 lg:grid-cols-2 2xl:grid-cols-3">
              {projects.map((project) => (
                ...
                <article
                  className={`
  group flex h-full min-w-0 flex-col overflow-hidden rounded-[1.4rem]
  border border-slate-200 bg-white
  shadow-[0_12px_35px_rgba(15,23,42,0.07)] transition duration-300
...
`}
  ...
  border border-white/30 bg-white/90 px-3 py-1.5 text-[10px]
  font-extrabold uppercase tracking-[0.14em] text-blue-700 shadow-sm
  backdrop-blur
`}>
                      <Layers3 size={12} />
                      Project
                  ...
                  <div className="flex flex-1 flex-col p-5 sm:p-6">
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <span className={`
  grid h-9 w-9 shrink-0 place-items-center rounded-full bg-blue-50
  text-blue-600 transition group-hover:bg-blue-600 group-hover:text-white
`}>
